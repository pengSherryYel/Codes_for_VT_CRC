...
### not run ###
### pharokka
#sh run_pharokka.sh $name $scaffolds_limit_length pharokka/$name
...
### bt alignment (align to oringal contig to build the mapping rate curve)
#. /home/viro/xue.peng/script/bt2.sh
#btbuild $checkv_opt_ori bt2Index/$name "--threads 10"
#btbuild $scaffolds bt2Index/$name "--threads 10"
...
##mmseqs easy-taxonomy $checkv_opt_ori /home/viro/xue.peng/software_home/mmseqs_db/NR_db/seqTaxOnlyVirusDB mmseqs/$name $mmseqs_tmp
#mmseqs easy-taxonomy $checkv_opt_ori /home/viro/xue.peng/software_home/mmseqs_db/swissprot_db/swissprot mmseqs/$name $mmseqs_tmp

### humann3 (all identified as bacteria)
