...
### bt alignment to scaffold (1st round for binning; and 4 sample can not binning)
#. /home/viro/xue.peng/script/bt2.sh
...
### bt alignment to uhgg (2nd round;binning with uhgg together)
#. /home/viro/xue.peng/script/bt2.sh
